...
def create_prompt(nameOfGod, region, dutyInCharge, religion, generalDescription, goal):
...
if __name__ == "__main__":
    # Prepare the goal
    goal = 'response to prayer ask how to ask girlfriend''s parents for blessing'
    ...
    # Construct prompt
    prompt = create_prompt(nameOfGod, region, dutyInCharge, religion, generalDescription, goal)
